...
| TKT-05 layout + Reveal + Footer | TASK-5 | sonnet | 🔄 in progress | S05.01–06 dispatched. **FOOTER CREDIT = "Built with curiosity." (TP10/E-1), NOT "Built with Claude Code" — plan §B S05.04 text is STALE (correction baked into brief); authorship colophon goes on /about (M-006).** |
