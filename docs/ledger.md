...
| M-002 fix-wave (EXE-7 + TKT-08) | TASK-8+ | sonnet | 🔄 next | EXE-7: FloatingTiles copy 12→14px (content floor), header subtitle `data-micro-label` exempt, /contact link ≥44, un-fixme the 2 eval-008 assertions. + TKT-08 S08r.01 resume-pii test infra (resumeAvailable stays false, blocked on PDF). Then M-002 QA-tester gate → merge → PING Tushar. |
