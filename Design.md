...
| Dev-47 | Credential badge artwork (Google Cloud, PMI, Scaled Agile, Scrum.org, AWS badges from Credly) renders as real images on `/certifications` — an EVAL-021 logo exception: they are Tushar's credentials, not brand decoration; files + sources in `public/media/certifications/README.md` | Tushar approved real logos 2026-09-26 | Tushar (2026-09-26) |
