...
| Dev-48 | All page openers outpainted to 21:9 and sized like the home banner — Tushar direction 2026-09-26 (TKT-107). The six scenes are 3168×1344 Higgsfield outpaints (the original scene kept, the room/landscape extended in the same watercolour style, no text); every opener uses the home banner's box: ≥ 768 the whole scene, height = width × 1344/3168 (≈ 611 px at 1440, equal to home at every width — Dev-40's whole-scene rule now ≥ 768 only); < 768 home's 4:3 (75 vw) crop centred on each scene's focal point, served from a pre-cropped narrow rendition (TKT-92r2 art direction) | Tushar 2026-09-26: "make the images of all the tabs same height and width similiar to Home tab" — Dev-40's 3:2 / 4:3 openers were 800–1075 px tall at 1440 vs home's ≈ 611 | Tushar (2026-09-26) |
