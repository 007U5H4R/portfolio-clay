...
| `/work/[slug]` header | photo caption annotation · media-tag sub-line annotation | 2 | taped photo frame; "Hero media coming" tag is `data-paper="tag"` content |
...
| `/thinking` opener | h1 underline sketch · hand-sub annotation "Notes first. Essays later." · photo caption annotation | 3 | taped photo |
...
| `/thinking/[slug]` essay | pinned-photo caption annotation · sticky aside (one generic line reused across essays) | 2 | pinned photo, `.prose` is `data-flat`; pull quotes `data-hand="quote"` |
...
| `/contact` opener | sticky "No form here…" · photo caption annotation · "whichever is easiest for you ↓" annotation | 3 | taped portrait |
