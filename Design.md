...
| Dev-80 | Polaroids pinned onto the banner's blank papers — Tushar direction 2026-09-26 (TKT-111) | Tushar: "move polaroids to blank canvases behind". TKT-105 left the wall papers blank, so the three polaroids (`scene-about`, `scene-playground`, `scene-work`) each sit taped inside one blank paper — the tall cream sheet left of the character, the square yellow note top-right, the large cream sheet right — tilted ≤ 2°, positioned and sized in banner-canvas pixels so they track the scene at every width ≥ 768; < 768 (round 2, Tushar "yes show polaroids there too") the same units ride the 4:3 crop — the tall cream sheet and yellow note carry theirs, the large cream sheet (≈ 18 % inside the crop, under the 80 % rule) keeps its polaroid hidden; lazy, never the LCP. Three papers, three polaroids, so no new polaroid was generated; the mountain photo and the now-clean corkboard stay bare. Replaces Dev-21's "polaroids over the corkboard / bottom-left" placement and the TKT-98 corkboard guard | Tushar (2026-09-26) |
