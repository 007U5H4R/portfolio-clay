...
- **[EXE-6] Deviation:** avatar frame is responsive (`w-full`, capped at the 280/360/480/520 ladder); actual width = min(cap, 35fr column) — hero grid balance revisited at M-003 with real FeaturedWork content.
