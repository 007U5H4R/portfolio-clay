/**
 * Primary nav copy (Design.md §4.1, decision D8 — TKT-71; TKT-101 Dev-42): `Home · Experience · Projects ·
...
export const navItems: NavItem[] = [
  ...
  // index moved to its own "Projects" tab at /projects — six items (Design.md §11 Dev-42).
