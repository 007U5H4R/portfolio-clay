 ...
 * Applies the 72/96/128px vertical-rhythm ladder (mobile/tablet/desktop) on the outer `<section>`
 * (the clay `tone` wash was retired in TKT-90a — paper sections set `data-paper` instead), wrapping children in `Container` so gutters/max-width
...
export function Section(props: SectionProps) {
  const { containerClassName, className, children, ...rest } = props;
