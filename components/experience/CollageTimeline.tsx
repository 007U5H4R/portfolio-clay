 ...
 * work-experience-target.png` + `education-target.png`; Design.md §7.2, §11 Dev-91). One component, two
 ...
 * logo card (the real logo, Dev-92, or the name set in type when no official file exists) → the rail pin
 * → a deckled torn-paper card (`data-paper="card"`) with the organisation (h3, Fraunces), the role
 * (Fraunces italic over a coloured stroke), the city chip (Dev-93) and the bullets. All card copy comes
