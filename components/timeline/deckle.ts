/**
 * deckle.ts (TKT-100) — deterministic torn / deckled paper outlines for the `/about` product journey
 * (Tushar direction 2026-09-26, about-journey-target.png). A verbatim copy of TKT-99's
 * `components/home/deckle.ts` (parallel branch) — dedupe into one shared module at merge. Pure
