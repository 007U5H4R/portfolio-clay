 ...
 *      SSR HTML. TKT-99 (Dev-41): the collage is ONE aria-hidden object whose pieces carry no data-decor.
...
describe("HowIThink (TKT-76, TC-148)", () => {
  ...
  it("renders the collage backdrop as one aria-hidden, text-free decoration (TKT-99, Dev-41)", () => {
    const section = renderSection(true);
