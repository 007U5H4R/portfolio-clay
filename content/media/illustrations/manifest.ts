...
export interface Illustration {
  id: "hero-desk" | "hero-banner" | "hero-clip" | "scene-work" | "scene-casestudy" | "scene-about" | "scene-thinking" | "scene-playground" | "scene-contact" | "character-sheet-b" | "tushky";
...
export const ILLUSTRATIONS: readonly Illustration[] = [
  ...
  {
    // TKT-104 (Design.md §11 Dev-48): the Ask panel mascot — the hero banner's golden retriever,
    // awake and waving on a round badge (Tushar 2026-09-26). Generated by the orchestrator with
    // Tushar's approved spend (Higgsfield `gpt_image_2_5`, job 6932218c-…, 0.5 cr; reference = a crop
    // of `hero-banner.webp`). Served as-is from public/ (256 px WebP with alpha) and rendered only
    // inside the lazy AskPanel chunk, never on a page (so `usedOn` names the panel, not a route).
    id: "tushky",
    kind: "mascot",
    file: "",
    publicSrc: "/media/illustrations/tushky.webp",
    width: 256,
    height: 256,
    alt: "Tushky, the golden retriever portfolio assistant",
