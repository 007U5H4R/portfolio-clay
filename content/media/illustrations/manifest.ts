 ...
 * TKT-107 (Dev-48): the six scenes are now 3168×1344 (21:9) Higgsfield outpaints — the home banner's size.
 */
...
export const ILLUSTRATIONS: readonly Illustration[] = [
  ...
  },
  {
    ...
    file: "scene-work.jpg",
    width: 3168,
    height: 1344, // TKT-107: 21:9 outpaint, the home banner's size (Dev-48)
